...
- **Live checkout amount doesn't match the "coffee" framing (Lens, plus direct verification: the live page shows product name "Support WordMD (buy me a frosty beverage)" and a $20.00 default).** Not fixed here — this is JJ's call on wording/amount, not a bug. Flagged to him directly rather than guessed at.
